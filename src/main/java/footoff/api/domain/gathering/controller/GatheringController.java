...
public class GatheringController {
    ...
    public ResponseEntity<BaseResponse<GatheringDto>> createGathering(
            @Valid @RequestBody GatheringRequestDto requestDto,
    ...
    public ResponseEntity<BaseResponse<String>> cancelMembership(
            @PathVariable Long gatheringId,
            @RequestHeader("X-User-Id") UUID userId) {
        gatheringService.cancelMembership(gatheringId, userId);
